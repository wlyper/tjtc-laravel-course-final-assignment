            ...
            <form class="needs-validation" novalidate action="/admin/editStudents" method="post">
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="" value="{{$student->studentName}}" name="studentName" required>
                    ...
                    <div class="col-sm-6">
                        ...
                        <select class="form-select" aria-label="Default select example"  value="{{$student->gender}}" name="gender" required>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="studentID" placeholder="" value="{{$student->studentID}}" name="studentID" required>
                        <div class="invalid-feedback">
                            请输入学号！
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="dateOfBirth" placeholder="" value="{{$student->dateOfBirth}}" name="dateOfBirth" required>
                            <div class="invalid-feedback">
                                请输入出生日期！
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="registrationDate" placeholder="" value="{{$student->registrationDate}}" name="registrationDate" required>
                            <div class="invalid-feedback">
                                请输入入学时间！
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="major" placeholder="" value="{{$student->major}}"name="major" required>
                            <div class="invalid-feedback">
                                请输学生所读专业！
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="telephone" placeholder="" value="{{$student->telephone}}" name="telephone" required>
                            <div class="invalid-feedback">
                                请输手机号码！
                            </div>
                        </div>
